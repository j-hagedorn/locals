...
Opportunity Insights is a non-partisan, not-for-profit organization based at Harvard University.  We incorporate data from their datasets which inform *The Opportunity Atlas: Mapping the Childhood Roots of Social Mobility*, specifically the following:

- [All Outcomes by Census Tract, Race, Gender and Parental Income Percentile](https://opportunityinsights.org/wp-content/uploads/2019/07/Codebook-for-Table-4.pdf)
- [Neighborhood Characteristics by Census Tract](https://opportunityinsights.org/wp-content/uploads/2019/07/Codebook-for-Table-9.pdf)  
